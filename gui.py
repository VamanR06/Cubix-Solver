from PySide6.QtWidgets import QApplication, QMainWindow, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QLabel, QGridLayout
...
class RubiksCubeApp(QMainWindow):
    def __init__(self):
        ...
        #########
        ## THIS IS NOT WORKING, THE VIDEO THREAD
        #########
        ...
        camera_placeholder = QLabel("camera placeholder")
        camera_placeholder.setAlignment(Qt.AlignCenter)
        camera_placeholder.setStyleSheet("border: 2px solid #666; padding-top: 160px; padding-bottom: 160px; margin 80px; font-size: 18px;")
        left_col.addWidget(camera_placeholder)
        ...
        cube_placeholder.setAlignment(Qt.AlignCenter)
        cube_placeholder.setStyleSheet("border: 2px solid #666; padding: 20px; margin: 10px; font-size: 18px;")
